...
\begin{table}[H]
    \centering
    \caption{Performance visualizations of different models across multiple forecast horizons.}
    ...
    \begin{tabular}{lccccc}
      ...
      \rotatebox{90}{Convformer}
        ...
        & \includegraphics[width=2.9cm]{720_Convformer.pdf} \\[1.8em]
      ...
      \rotatebox{90}{{} Informer}
        ...
        & \includegraphics[width=2.9cm]{720_Informer.pdf} \\[1.8em]
      ...
      \rotatebox{90}{Autoformer}
        ...
        & \includegraphics[width=2.9cm]{test.pdf} \\[1.8em] % TODO 720_Autoformer.pdf
      ...
      \rotatebox{90}{{} Reformer}
        ...
        & \includegraphics[width=2.9cm]{720_Reformer.pdf} \\[1.8em]
      ...
      \rotatebox{90}{ConvStem}
        ...
        & \includegraphics[width=2.9cm]{720_ConvStem.pdf} \\[1.8em]
      ...
      \rotatebox{90}{{} {} Decomp}
        ...
        & \includegraphics[width=2.9cm]{720_Decomp.pdf} \\[1.8em]
      ...
      \rotatebox{90}{{} {} {} FAVOR}
        ...
        & \includegraphics[width=2.9cm]{720_FAVOR.pdf} \\[1.8em]
    \end{tabular}
    }
\end{table}
